...
int main() {
  ...
  // All the main code loops in h.onMessage(), to have access to intial variables 
  // that we created at the beginning of main(), we pass pointers as arguments 
  // into the header of h.onMessage()
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //creation of MeasurementPackage instance
          // this is where simulator data is stored
